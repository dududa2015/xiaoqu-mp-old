  ...
  initQuestions() {
    const questions = [
      ...
      },
      {
        id: 5,
        category: 'hot',
        question: '试用期结束后，之前添加的标记会消失吗？',
        answer: '不会，APP试用期结束后，已审核通过的标记将保留，订阅后可继续查看和管理。'
      },
      // 基础操作类
      {
        id: 6,
      ...
      },
      {
        ...
        answer: '可以添加楼号、出入口、公厕、维修点、换电站、外卖柜、生活类、道路、围墙等九种类型的标记。'
      },
      // 导航功能类
      {
        id: 29,
      ...
      // 订阅付费类
      {
        ...
        question: '试用期有多长？',
        answer: 'APP提供3天免费试用期，试用期内可以体验全部功能。'
      },
      {
        id: 48,
        category: 'subscription',
        question: '试用期结束后功能受限吗？',
        answer: '试用期结束后，需要订阅方可继续使用全部功能。已审核通过的标记将保留，订阅后可继续查看和管理。'
      },
      {
        id: 49,
        category: 'subscription',
        question: '如何订阅？',
        answer: '试用期结束前或结束后，系统会提示您订阅。您可以在升级会员页面或相关提示页面完成订阅操作。'
      },
      {
        id: 50,
        category: 'subscription',
        question: 'iOS平台如何取消订阅？',
        answer: '可以取消。订阅后可以在iOS设备的管理订阅中取消，取消后将在当前订阅周期结束后停止续费，当前订阅周期内仍可正常使用。',
        solutions: [
          'iOS平台取消订阅详细操作步骤：',
          '1) 打开iPhone/iPad的"设置"应用',
          '2) 点击顶部的Apple ID（您的姓名）',
          '3) 选择"订阅"选项',
          '4) 在订阅列表中找到"小区楼号地图"或相关应用',
          '5) 点击进入订阅详情页面',
          '6) 点击"取消订阅"按钮',
          '7) 在弹出的确认对话框中点击"确认"完成取消',
          '',
          '注意事项：',
          '• 取消后，您仍可在当前订阅周期结束前继续使用全部功能',
          '• 到期后将自动停止续费，不会产生额外费用',
          '• 如需重新订阅，可在到期后重新购买',
          '• 取消订阅后，当前订阅周期内的服务不受影响'
        ]
      },
      {
        id: 51,
        category: 'subscription',
        question: 'Android平台如何取消订阅？',
        answer: '可以取消。订阅后可以通过微信支付或Google Play的管理订阅中取消，取消后将在当前订阅周期结束后停止续费，当前订阅周期内仍可正常使用。',
        solutions: [
          'Android平台微信支付取消订阅详细操作步骤：',
          '1) 打开微信APP，点击右下角"我"',
          '2) 点击"服务"（旧版显示为"支付"）',
          '3) 点击"钱包"选项',
          '4) 点击"支付设置"（或点击右上角的"..."三个点）',
          '5) 选择"扣费服务"（或"自动扣费"）选项',
          '6) 在扣费服务列表中找到"小区楼号地图"或相关应用',
          '7) 点击进入该服务的详情页面',
          '8) 点击"关闭服务"或"解约"按钮',
          '9) 根据提示验证支付方式（指纹/面容/密码），确认关闭',
          '',
          '提示：如果找不到"扣费服务"选项，可以尝试：',
          '• 在微信中搜索"微信支付" → 进入"我的服务" → 找到"扣费服务"',
          '• 或者通过微信支付公众号 → 进入"我的服务" → "扣费服务"',
          '• 确保微信版本为最新版本，部分旧版本路径可能略有不同',
          '',
          '注意事项：',
          '• 取消后，您仍可在当前订阅周期结束前继续使用全部功能',
          '• 到期后将自动停止续费，不会产生额外费用',

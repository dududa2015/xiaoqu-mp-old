  ...
  initQuestions() {
    const questions = [
      ...
      },
      {
        id: 47,
        category: 'hot',
        question: '小程序现在还有使用时长限制吗？',
        answer: '没有。小程序已取消每日免费半小时的限制，楼号查询、收藏和路线等核心功能可全天使用，也不需要观看激励视频解锁。封面广告、插屏广告和格子广告也已取消。'
      },
      // 基础操作类
      {
        id: 6,

  ...
  initQuestions() {
    const questions = [
      ...
      },
      {
        id: 4,
        category: 'hot',
        question: '添加的标记可以共享给别人吗？',
        answer: '不可以。小程序现为个人地图工具，您添加的标记仅本人可见，无法共享给其他用户。分享小程序入口后，对方打开的是自己的个人地图，看不到您的标记。'
      },
      {
        id: 5,
        category: 'hot',
      ...
      },
      {
        id: 24,
        category: 'marker',
        question: '为什么看不到别人添加的标记？',
        answer: '当前为个人地图工具，地图上只显示您自己添加的标记，其他用户的标记不会出现在您的地图上，也无法互相编辑。'
      },
      {
        id: 25,
        category: 'marker',
      ...
      },
      {
        ...
        category: 'map',
        question: '现在还有公共地图吗？',
        answer: '没有。小程序已改为个人地图工具，不再提供公共地图，也无法在用户之间共享标记。地图上展示的都是您自己添加和管理的内容。'
      },
      {
        id: 35,
        category: 'map',
      ...
      },
      {
        id: 36,
        category: 'map',
        question: '可以把标记分享或导入给其他账号吗？',
        answer: '不可以。个人地图中的标记只绑定当前微信账号，无法共享、转让或导入到其他账号。换机后需使用同一微信登录，才能继续查看自己的标记。'
      },
      // 权限审核类
      {
        id: 37,
      ...
      },
      {
        id: 41,
        category: 'permission',
        question: '为什么地图上没有其他人的标记？',
        answer: '当前为个人地图，不会展示其他用户添加的内容。您只能查看、编辑和删除自己创建的标记。'
      },
      // 技术故障类
      {
        id: 42,
      ...
      },
      {
        ...
        category: 'tech',
        question: '分享功能无法使用？',
        answer: '如果分享小程序入口失败，请检查：1) 微信版本是否为最新；2) 网络连接是否正常；3) 尝试重新进入小程序后再分享。请注意：分享的是小程序本身，不会把您的个人标记共享给对方。'
      }
    ];

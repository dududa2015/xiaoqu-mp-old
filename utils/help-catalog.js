...
const SECTIONS = [
  {
    ...
    blocks: [
      ...
      h3('文档目的'),
      p('介绍微信小程序版的主要功能、界面布局与操作步骤，帮助您快速上手个人地图浏览、标记管理与路线查看。可在本页搜索或按分类浏览具体主题。'),
      h3('相关入口'),
      bullets([
        '使用帮助：「我的 → 使用帮助」（当前页面）；',
        '常见问题：「我的 → 常见问题」；',
  ...
  },
  {
    ...
    category: 'intro',
    title: '核心功能一览',
    summary: '个人地图浏览、标记、收藏与路线',
    blocks: [
      p('「小区楼号」微信小程序是一款个人地图工具，用于在小区内查询楼号并标注自己的地点，主要能力包括：'),
      bullets([
        '在个人地图上查看自己添加的楼号、出入口、设施等标记；',
      ...
      note('当前为个人地图，添加的标记仅本人可见，无法共享给其他用户。')
    ]
  },
  {
    id: 12,
    category: 'intro',
    title: '个人地图说明',
    summary: '标记仅本人可见，无法共享给他人',
    blocks: [
      h3('什么是个人地图'),
      p('本小程序现为个人地图工具。您在地图上添加、编辑的楼号、出入口、设施等标记，只保存在自己的账号下，仅本人可见。'),
      h3('无法共享标记'),
      bullets([
        '其他用户看不到您添加的标记；',
        '分享小程序给好友后，对方打开的是自己的个人地图，不会看到您的标记；',
        '无法把标记同步或转让给其他账号。'
      ]),
      h3('数据保存'),
      p('登录后，标记会与当前微信账号绑定并同步到服务器。换机后使用同一微信打开，即可继续查看自己的标记。')
    ]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    blocks: [
      ...
      h3('与 App 的关系'),
      p('使用同一微信账号登录小区楼号 App 后，标记等业务数据可以互通。小程序中的标记属于个人地图，不会共享给其他用户。'),
      h3('换机后'),
      p('只要仍使用同一微信账号打开本小程序，标记与收藏会从服务器同步，一般无需重新添加。')
    ]
  },
  {
    id: 5,
    ...
    blocks: [
      ...
      p('小程序底部为两个主 Tab：'),
      bullets([
        '地图：浏览个人地图、添加标记、搜索、分享与设置；',
        '我的：查看账号、标记统计、使用帮助与客户服务。'
      ]),
  ...
  },
  {
    ...
    category: 'map',
    title: '分享功能',
    summary: '可分享小程序入口，不会共享个人标记',
    blocks: [
      p('点击地图顶部「分享」，或使用微信右上角「···」转发，可以把小程序入口发给微信好友或群聊。'),
      note('分享的是小程序本身，不会把您的个人标记共享出去。对方打开后看到的是自己的个人地图，无法查看、复制或修改您添加的标记。')
    ]
  },
  {
    id: 9,
  ...
  },
  {
    ...
    blocks: [
      ...
      h3('标记仅本人可见'),
      p('当前为个人地图工具，您添加的标记只保存在自己的账号下，其他用户无法查看、修改或删除。分享小程序也不会把这些标记共享给对方。')
    ]
  },
  {
    id: 14,
    ...
    blocks: [
      ...
      h3('注销账号'),
      p('在编辑资料页底部选择「注销账号」。注销后将清除昵称、手机号与微信绑定，且无法恢复。'),
      bullets([
  ...
  },
  {
    ...
    blocks: [
      ...
      p('请先查看本帮助「定位与权限」。'),
      h3('分享失败'),
      p('请确认微信版本较新，并尝试使用右上角「···」转发。分享小程序不会把您的个人标记共享给对方。'),
      h3('标记「不见了」'),
      bullets([
        '确认是否使用添加标记时的同一微信账号；',
        '个人地图中的标记仅本人可见，换号登录后看不到原账号的标记；',
        '仍异常可通过「我的 → 客户服务」联系我们。'
      ])
    ]
  },
  {
    ...
    blocks: [
      p('使用中遇到问题或有功能建议，可通过「我的 → 客户服务」联系我们。'),
      bullets([
